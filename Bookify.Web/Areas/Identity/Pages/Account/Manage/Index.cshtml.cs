...
namespace Bookify.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                var imagePath = $"/images/users/{user.Id}.png";

                var imageName = $"{user.Id}.png";
                _imageService.DeleteImage(imagePath, null);
                var (isUploaded, errorMessage) = await _imageService.UploadAsync(Input.Avatar, imageName, "/images/users", hashThumbnail: false);
            ...
            else if (Input.ImageRemoved)
            {
                ...
                _imageService.DeleteImage($"/images/users/{user.Id}.png", null);
