    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    {"[imageUrl]","https://res.cloudinary.com/eleash/image/upload/v1733867458/icon-positive-vote-2_m8ecv7.svg"},

                    {"[header]", $"Welcome {user.FullName},"},
                    {"[body]","please click the below button to reset your password, good luck " },
