namespace Bookify.Domain.Consts
{
    public static class Errors
    {
        ...
        public const string OherMaxLength = "{PropertyName} cannot be more than {MaxLength} characters";
        ...
        public const string InvalidEmail = "The email address is invalid. Please ensure it follows the format 'example@domain.com";
        ...
        public const string ExceedTheMax = "You cannot add more than the number of book(s) available to you";
